...
5. Press `CTRL-D` to restart the ESP. Browse to [MicroPython browser WebREPL client](https://micropython.org/webrepl/) and connect to the ESPs IP address to access the WebREPL.
