...
including consideration of when you shouldn't build a service. There is a more effective design that gets you what
...
If your target is low latency/geographic co-location: you can't get more co-located than serving the request in the
